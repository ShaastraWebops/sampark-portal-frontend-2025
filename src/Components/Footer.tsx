    ...
    <footer className="relative bg-[#0a1128] text-white pb-10 mt-10">
      <div className="container mx-auto px-5 flex flex-col md:flex-row justify-between mt-12">
        <div className="mb-8 md:mb-0">
          <h3 className="text-orange-400 font-bold mb-3 text-2xl">
            Developers
          </h3>
        ...
        <div className="mb-8 md:mb-0">
          ...
          <ul className="space-y-3">
            <li>
              ...
              <a href="tel:+917975016134" className="text-blue-400">
                +91 7975016134
              </a>
            </li>
            <li>
              ...
              <a href="tel:+917404769417" className="text-blue-400">
                +91 7404769417
              </a>
            </li>
            <li>
              ...
              <p>Publicity Coordinator, Shaastra</p>
              <a href="tel:+919156450775" className="text-blue-400">
                +91 9156450775
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-20">
            <a
              ...
              onClick={() => window.open("https://www.facebook.com/Shaastra/")}
            >
            ...
            <a
              ...
              onClick={() =>
                window.open(
                  "https://in.linkedin.com/company/shaastra-iit-madras"
                )
              }
            >
