...
const Container: React.FC = () => {
  ...
  useEffect(() => {
    ...
    <div className='w-full flex justify-center'><button className="text-lg md:text-2xl rounded-lg hover:bg-sky-700 mt-3 bg-sky-500 p-2 font-bold">Register Now</button>
    </div> </div></div>)
}
